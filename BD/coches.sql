...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2019 a las 20:02:52
...
CREATE TABLE IF NOT EXISTS `contiene` (
  ...
  PRIMARY KEY (`CodMod`,`CodPed`),
  KEY `CodPed` (`CodPed`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- RELACIONES PARA LA TABLA `contiene`:
--   `CodMod`
--       `modelo` -> `CodMod`
--   `CodPed`
--       `pedido` -> `CodPed`
...
(4, 'Cristian', 'admin@admin.es', '827ccb0eea8a706c4c34a16891f84e7b', 'Lobo', NULL, NULL, 1, '5a798ee086b337910e10abf68fe6d83f'),
(5, 'Abel', 'anurse0@prnewswire.com', 'a883a649abdfc51e0d1dd945f5bf6183', 'Nurse', '1990-09-30', 'https://robohash.org/optioquodinventore.jpg?size=50x50&set=set1', 0, NULL),
(6, 'Abie', 'asywell1@geocities.com', 'e7d39bb9919c45a3b52c0fcef0a511f0', 'Sywell', '2010-12-18', 'https://robohash.org/estestet.jpg?size=50x50&set=set1', 1, NULL),
(7, 'Paton', 'pbunton2@slate.com', '4b87c103fe18b41e5740ae615c65ee77', 'Bunton', '2013-03-22', 'https://robohash.org/eaharumfuga.jpg?size=50x50&set=set1', 0, NULL),
(8, 'Gasparo', 'gbottoms3@archive.org', '77036178c1a5bb0d389e181c33f8b004', 'Bottoms', '1989-03-14', 'https://robohash.org/aspernaturrepudiandaedolores.jpg?size=50x50&set=set1', 0, NULL),
(9, 'Julian', 'jgricewood4@ucoz.com', '0c792ba2997602ee9902fa836c1818d5', 'Gricewood', '1994-07-29', 'https://robohash.org/molestiasexercitationemvoluptatem.jpg?size=50x50&set=set1', 0, NULL),
...
(31, 'Robbi', 'rthorndaleq@salon.com', '744349a93c6ecbc29eb77bd05ce5e1ac', 'Thorndale', '2004-04-14', 'https://robohash.org/quamutillo.jpg?size=50x50&set=set1', 0, NULL),
...
(34, 'Ambrose', 'aattot@topsy.com', '55cc9f210503494002d85d3c24af98b8', 'Atto', '1992-04-03', 'https://robohash.org/quasiautunde.jpg?size=50x50&set=set1', 1, NULL),
...
(47, 'Randie', 'rsimka16@themeforest.net', '4ce5cd6de83a9bdb1c207032d161fa1a', 'Simka', '2013-06-14', 'https://robohash.org/estassumendarepellendus.jpg?size=50x50&set=set1', 1, NULL),
...
(50, 'Dominica', 'dneachell19@weebly.com', '1d87d7a28a5000dee277853fb5f5d43f', 'Neachell', '1988-10-25', 'https://robohash.org/adexercitationemcumque.jpg?size=50x50&set=set1', 0, NULL),
...
(96, 'Leisha', 'llynes2j@army.mil', 'b4c6800f60baf986f4828212370005f7', 'Lynes', '2007-07-09', 'https://robohash.org/laudantiumdebitisneque.jpg?size=50x50&set=set1', 1, NULL),
(97, 'Rolland', 'rbartolomucci2k@army.mil', '6b6ef8a35cd4f15e6eaad6676ff96c0d', 'Bartolomucci', '1983-07-06', 'https://robohash.org/etperspiciatisqui.jpg?size=50x50&set=set1', 0, NULL),
(98, 'Roby', 'rravenscroft2l@tumblr.com', 'a20367ea8eecdbe6229973be2e09e35c', 'Ravenscroft', '2007-01-23', 'https://robohash.org/liberoaspernaturratione.jpg?size=50x50&set=set1', 1, NULL),
(99, 'Norris', 'nmcguinley2m@blogspot.com', '10e01c62aa0d7672c8b3d6893e28a932', 'McGuinley', '2004-10-28', 'https://robohash.org/deseruntquiminus.jpg?size=50x50&set=set1', 1, NULL),
(100, 'Adolphus', 'asizeland2n@cdbaby.com', '99f04ed83a7fd106bd22c942cc99592e', 'Sizeland', '1989-03-01', 'https://robohash.org/nemoautsed.jpg?size=50x50&set=set1', 1, NULL),
(101, 'Martie', 'mmorman2o@guardian.co.uk', '05c188ab605347a5a8397690432d4d59', 'Morman', '2008-05-04', 'https://robohash.org/saepeetvelit.jpg?size=50x50&set=set1', 0, NULL),
(102, 'Lydia', 'lkernaghan2p@goo.gl', 'b83761f39ca9184c8ba99e335d2a2acd', 'Kernaghan', '2013-11-04', 'https://robohash.org/expeditamolestiaeesse.jpg?size=50x50&set=set1', 0, NULL),
(103, 'Derek', 'dgorioli2q@ezinearticles.com', 'cff0ee120cd7366563deb0d20fbb15fe', 'Gorioli', '2010-02-25', 'https://robohash.org/cupiditateblanditiisquasi.jpg?size=50x50&set=set1', 1, NULL),
(104, 'Adina', 'ayude2r@china.com.cn', '6831a18807c7c780e6752702bfdd529a', 'Yude', '1991-04-16', 'https://robohash.org/nullaaperiamratione.jpg?size=50x50&set=set1', 0, NULL);
